...
function step(box, options) {
  (0, _setStyle.default)(box, options);
  return (0, _promise.default)(options.trms);
}
...
var _default = (tape, options) => Promise.all([steps(tape.now, options.active), steps(tape.next, options.next)]);
